...
| Instead of | Write |
| --- | --- |
| I am running four agents on ounass.com | Reading ounass.com now |
| I have already read ounass.com | Here is ounass.com, as I read it |
| I would say $60,000 at 5× | Start at $60,000 and 5× |
...
| Instead of | Write |
| --- | --- |
| That is a good combination of budget and target return | $60,000 ÷ 5 = 12,000. We commit at 12,000 |
...
### 7. Em-dashes: one per message, maximum

The current copy uses them as a comma, a colon and a full stop, sometimes
in the same sentence. Pick the real punctuation mark.
